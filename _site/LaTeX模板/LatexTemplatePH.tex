...
Use \texttt{TeXstudio} in macOS and Windows platforms. 

Use \texttt{ShareLaTeX} for on-line sharing or co-working. 





\section{My way to ref a figure}

See below:

Label of equation should be \texttt{eq:xxx}. 

Label of figure should be \texttt{fig:secXX\_xxx}. 

Label of subfigure should be \texttt{subfig:secXX\_xxx}. 

Label of tab should be \texttt{tab:secXX\_xxx}. \\

Refer an equation by \texttt{\textbackslash cref\{eq:xxx}\}. 

Refer a figure by \texttt{\textbackslash cref\{fig:secXX\_xxx}\}. 

Refer a table by \texttt{\textbackslash cref\{tab:secXX\_xxx}\}. 

Refer a table by \texttt{\textbackslash cref\{tab:secXX\_xxx}\}. 



\section{Use subfigure}
See codes for an example. 
%\begin{figure}[!ht]
%	\centering
...
%					\includegraphics[width=\textwidth]{svm/{1.00sigma-NRLMSISE00-ex-day0-21-21-28-test-metrics}.png} \\
%					\includegraphics[width=\textwidth]{svm/{1.00sigma-NRLMSISE00-ey-day0-21-21-28-test-metrics}.png} \\
%					\includegraphics[width=\textwidth]{svm/{1.00sigma-NRLMSISE00-ez-day0-21-21-28-test-metrics}.png} \\
%				\end{minipage}
%			}
%			\hspace{1em}
%			\subfigure[ANN]{
%				\begin{minipage}{.75\textwidth}
%					\includegraphics[width=\textwidth]{ann/{ex-day0-21-21-28-test-metrics}.png} \\
%					\includegraphics[width=\textwidth]{ann/{ey-day0-21-21-28-test-metrics}.png} \\
%					\includegraphics[width=\textwidth]{ann/{ez-day0-21-21-28-test-metrics}.png} \\
%				\end{minipage}
%			}
%		}
%		\caption{Individual performance metrics $p_{ML}$ on testing data (week 1--3 $\Rightarrow$ week 4). From top to bottom: $e_x$, $e_y$, $e_z$.}
%		\label{fig:position_pML}
%	\end{figure}
%\end{landscape}
