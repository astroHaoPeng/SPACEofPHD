...
{% fullimage "./three-generalization-capabilities.png", , Illustration of three types of generalization capability., 400px %}
...
{% fullimage "./machine-learning-aerospace-dataset.png", , Illustration of the dataset used in the Machine Learning approach. (click to zoom-in), 500px %}
...
{% fullimage "./generalization-to-nearby-rsos.png", , Generalization capability to nearby RSOs with different RAAN and semi-major axis., 400px %}
...
{% fullimage "./gp-uncertainty-position.png", , , 500px %}
{% fullimage "./gp-uncertainty-velocity.png", , Uncertainty information generated by the GP models., 500px %}
...
{% fullimage "./compare_svm_ann_gp.png", , Comparison of the performance of SVM / ANN / GP on four SSO objects., 500px %}
...
{% fullimage "./tle-orbits.png", , TLE orbits used to validate the ML approach., 500px %}
...
{% fullimage "./me-halo-orbit-demo1.png", , Examples of the newly discovered ME-Halo orbit in the ERTBP., 400px %}

{% fullimage "./me-halo-orbit-stability.png", , Bifurcation and collision of statiblity of the ME-Halo orbit family., 500px %}
{% endnote %}
...
{% fullimage "./me-halo-orbit-sun-mercury-system.png", , ME-Halo orbit in the Sum-Merucry ERTBP model. with the exact eccentricity and mass ratio, 500px %}
{% endnote %}
<!-- endtab -->
...
{% fullimage "./ertbp-patched-model.png", , Patched Sun-Earth/Moon ERTBP and Earth-Moon ERTBP model, 400px %}

{% fullimage "./ertbp-gpu-parallel.png", , Low-energy transfer trajectory designed in the Patched ERTBP model, 500px %}
...
{% fullimage "./me-halo-orbit-transfer-impulsive.png", , Impulsive transfer along the two-dimensional stable manifold to a lunar ME-Halo oribt., 500px %}
{% endnote %}
...
{% fullimage "./me-halo-orbit-transfer-low-energy.png", , Examples of the low-energy transfer a lunar ME-Halo oribt., 400px %}
{% endnote %}
<!-- endtab -->
...
{% fullimage "./me-halo-orbit-formation.png", , Examples of a natural formation configuration in the Earth-Moon ERTBP model., 500px %}
{% endnote %}
...
{% fullimage "./me-halo-orbit-control.png", , Example of the designed receding horizon controller that could easily stablize an ME-Halo orbit in the Sun-Mercury ERTBP system and in the ephemeris system., 300px %}
{% endnote %}
<!-- endtab -->
