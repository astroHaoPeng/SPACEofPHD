...
Most of the content in the thesis have been published in English in top-ranking journals, please check the [Restricted Three-Body Problem](#restricted-three-body-problem) section below.
...
During the undergraduate studies and 
 I have taken a lot of courses in Aerospace and Math.

Since 2011 when I starting my PhD studying (till the updating date of this page), I have published 15 papers and almost attended top conferences every year. 
Detailed publications are referred to the following [Academic Contributions](#academic-contributions) section.
...
{% note info %}
`(J)` Peng, H., Bai, X., 2019. Gaussian Processes for Improving Orbit Prediction Accuracy. Acta Astronautica 0, 0.\
...
{% note info %}
`(C)` Peng, H., Bai, X., 2018c. Generalization Capability of Machine Learning Approach Among Different Satellites: Validated Using TLE Data, in: AAS/AIAA Astrodynamics Specialist Conference. Presented at the AAS/AIAA Astrodynamics Specialist Conference, Snowbird, UT, pp. 1--17.
