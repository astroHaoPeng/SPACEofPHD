...
(see https://www.cs.ubc.ca/~murphyk/Teaching/CS540_Fall05/software.html)

The programming language for CS540 will be Matlab. You will be required to learn this, if you do not already know it (see these Matlab tutorials.) If you do not have access to matlab, you can either buy a student copy from the UBC bookstore ($150), or you can apply for a CS guets account.
Matlab
The following packages (all either written in, or callable from, Matlab) may be useful for your final project.
